...
export default function MeetTheTeamHero() {
    return (
        <div className={"flex px-[6%] gap-16 md:py-0 pb-20 pt-40 items-center md:flex-row flex-col md:justify-between min-h-screen"}>
            <div className={"flex w-full flex-col h-full"}>
                ...
                <h1 className={"text-3xl md:text-5xl font-bold"}>
                    Meet Our <span className={"text-brand-teal mx-1"}>Business Finance</span>
                    Broker Team
                </h1>
