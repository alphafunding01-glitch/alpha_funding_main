                    ...
                    <div className={"flex flex-col justify-between h-full w-full gap-1"}>
                        <div className={"flex flex-col gap-2"}>
                            ...
                            <h1 className={"text-3xl md:text-5xl font-bold"}>
                                Apply for Business Finance Solutions from Alpha Funding
                            </h1>
                        </div>
                        <p className={`${poppins.className} text-sm mt-4`}>
                            You're just a few steps away from transforming your capabilities with our business finance
                            solutions! To apply, simply enter a few initial details and we'll be in touch with you
                            shortly.
                        </p>
